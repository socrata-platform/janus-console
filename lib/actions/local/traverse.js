  ...
  TraverseAction = (function(_super) {
    ...
    TraverseAction.prototype._handle = function() {
      var verse,
        _this = this;
      verse = function() {
        var currentPage, firstPart, k, locals, objs, parts, recurse, v, _ref3, _ref4;
        ...
        if ((parts == null) || parts.length === 0) {
          ...
          _ref3 = _this.request.options.env;
          for (k in _ref3) {
            v = _ref3[k];
            locals[k] = v != null ? (_ref4 = v.value) != null ? _ref4.successOrElse(null) : void 0 : void 0;
          }
          objs = [];
